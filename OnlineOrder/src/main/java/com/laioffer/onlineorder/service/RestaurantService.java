...
public class RestaurantService {
    ...
    private final MenuItemRepository menuItemRepository;//depends on these two repositories
...
//
//
//        Map<Long, List<MenuItemEntity>> groupedMenuItems = menuItemEntities.stream()
...
//                        new RestaurantDto(restaurantEntity,
